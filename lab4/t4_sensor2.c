...
//
// uses the potentiometer and allows the user to look at min/max values of pot
// *****************************
#include    "esos.h"
...
// Task to display output of potentiometer every 1 second
...
void user_init(void) {
  ...
  mode = 1;
  //Need new input task
  esos_RegisterTask(SW1_READ_POT);
  esos_RegisterTask(SW2_READ_POT);
